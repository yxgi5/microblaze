...
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AB4 } [get_ports {rgmii_td[0]}]
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AA4 } [get_ports {rgmii_td[1]}]
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AA3 } [get_ports {rgmii_td[2]}]
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN AA2 } [get_ports {rgmii_td[3]}]
set_property -dict {IOSTANDARD LVCMOS18 PACKAGE_PIN Y3  } [get_ports {rgmii_tx_ctl}]
